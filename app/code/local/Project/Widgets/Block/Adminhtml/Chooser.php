 ...
 */
class Project_Widgets_Block_Adminhtml_Chooser extends Mage_Adminhtml_Block_Widget_Form_Renderer_Fieldset_Element
{
    ...
    public function render(Varien_Data_Form_Element_Abstract $element)
    {
        ...
        $label = ($element->getValue()) ? $this->__('Change Media') : $this->__('Insert Media');
        ...
        $emptyTableRow = '</td></tr><tr><td></td><td></td></tr><tr><td>';

        $element->setData('after_element_html', $previewHtml . $chooseButton->toHtml() . $removeButton->toHtml() . $emptyTableRow);
